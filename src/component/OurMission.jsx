...
const OurMission = () => {
  return (
    <div
      className="bg-mission flex flex-col md:flex-row items-center gap-8 lg:space-x-24 justify-center md:items-start lg:gap-x-20 bg-cover bg-top py-6 md:py-12 px-10 lg:py-24"
      id="mission"
    >
